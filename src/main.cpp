...
#if defined(NDEBUG)
#error "401K Coin cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 10 * 60;//60 * 60;myfix
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // 401K: We use certain sporks during IBD, so check to see if they are
